...
class App(cti.CTk):
    def __init__(self):
        ...
        self.button_search = cti.CTkButton(master=self, command=self.search_button_callback, text="Search")
        self.button_search.grid(row=2, column=2, padx=10, pady=20, sticky="ew")

        self.buttonConnect = cti.CTkButton(master=self, command=self.connect_button_callback, text="Connect")
